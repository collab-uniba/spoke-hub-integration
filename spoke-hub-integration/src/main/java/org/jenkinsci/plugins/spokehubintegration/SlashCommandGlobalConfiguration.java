 ...
 */
@Extension
public class SlashCommandGlobalConfiguration extends GlobalConfiguration {
	 ...
	 */
    public SlashCommandGlobalConfiguration() {
        load();
    }
     ...
     */
    public static SlashCommandGlobalConfiguration getInstance() {
    	return GlobalConfiguration.all().get(SlashCommandGlobalConfiguration.class);
    }
